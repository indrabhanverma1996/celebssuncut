         ...
         <div class="col-xl-6 col-xxl-8 col-lg-8">
            <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
               ...
               <div class="card-body p-0 position-relative d-flex profile-delarea">
                  <figure class="avatar position-absolute w100 z-index-1" style="top:-40px; left: 30px;"><img src="{{url('/')}}/public/images/{{$user->profile_image}}" alt="image" class="float-right p-1 bg-white rounded-circle w-100"></figure>
                  <h4 class="fw-700 font-sm mt-2 mb-4 pl-15">{{Auth::user()->name}}<span class="fw-500 font-xssss text-grey-500 mt-1 mb-3 d-block">{{Auth::user()->nickname}}fds
                     </span>
                  </h4>
