            ...
            <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
               <div class="card-body h250 p-0 rounded-xxl overflow-hidden m-3 profile-cover">
                  ...
                  <div class="vip-logo">
                     ...
                     <h4> <a href="#" class="text-center p-2 lh-24 ms-1 ls-3 d-inline-block rounded-xl bg-current font-xssss fw-700 ls-lg subscribe text-white"><span>Subscribe For Free </span>
                        </a>
                     </h4>
                  </div>
               </div>plan_name
               <div class="card-body p-0 position-relative">
                  ...
                  <div class="profil-text">
                     <h5><b>Fitness | Lifestyle | Motivation... </b></h5>
                     <p class="profile-flower"><span class="star-f maroon-bg"><img src="{{url('/')}}/public/front_assets/images/i1.png"> </span> <span class="star-f"><img src="{{url('/')}}/public/front_assets/images/star.jpg"> </span>Super Star <span>10m + followers</span></p>
                  </div>
               ...
               <div class="card-body d-block w-100 shadow-none mb-0 p-0 border-top-xs">
                  <div class="social-media-s">
                     <ul>
                        <li>
                           <a href="#"><img src="{{url('/')}}/public/front_assets/images/i.png"></a>
                        </li>
                        <li>
                           <a href="#"><img src="{{url('/')}}/public/front_assets/images/f.png"></a>
                        </li>
                        <li>
                           <a href="#"><img src="{{url('/')}}/public/front_assets/images/t.png"></a>
                        </li>
                        <li>
                           <a href="#"><img src="{{url('/')}}/public/front_assets/images/u.png"></a>
                        </li>
                        <li>
                           <a href="#"><img src="{{url('/')}}/public/front_assets/images/t0.png"></a>
                        </li>
                        <li>Check out my personalised UnCUT subscription packages<a href="#" data-toggle="modal" data-target="#uncutsubscribe"> Click Here</a></li>
                     </ul>
                  </div>
                  <div class="tabset">
                     <!-- Tab 1 -->
                     <input type="radio" name="tabset" id="tab1" aria-controls="aboutinfo" checked>
                     <label for="tab1">About Info</label>
                     <input type="radio" name="tabset" id="tab2" aria-controls="marzen">
                     <label for="tab2">{{$postcount}}  Posts</label>
                     <!-- Tab 2 -->
                     <input type="radio" name="tabset" id="tab3" aria-controls="rauchbier">
                     <label for="tab3">499 Media</label>
                        ...
                        <section id="aboutinfo" class="tab-panel">
                           <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                              ...
                              <div class="card-body p-0 d-flex">
                                 <div class="row">
                                    <div class="col-md-5"><img src="{{url('/')}}/public/front_assets/images/pinfo.jpg"></div>
                                    <div class="col-md-7">
                 ...
                 @endif
                        ...
                        <section id="rauchbier " class="tab-panel ">
                           <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3 ">
                              <div class="card-body p-0 d-flex ">
                                 <figure class="avatar me-3 "><img src="{{url('/')}}/public/front_assets/images/Lorrie-Morgan.jpg" alt="image " class="shadow-sm rounded-circle w45 "></figure>
                              ...
                              <div class="card-body p-0 mb-3 rounded-3 overflow-hidden ">
                                 <video loop autoplay muted controls class="float-right w-100 ">
                                    <source src="{{url('/')}}/public/front_assets/images/v-2.mp4 " type="video/mp4 ">
                                 </video>
                              </div>
                              <div class="card-body p-0 me-lg-5 ">
