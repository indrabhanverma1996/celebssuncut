                        ...
                        <div class="col-xl-6 col-xxl-8 col-lg-8">                                              
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                ...
                                <div class="card-body p-0 position-relative">
                                   ...
                                   <ul class="uncut-subscribe">

                                       <li><img src="{{url('/')}}/front_assets/images/logo.png"></li>

                                       <li><img src="{{url('/')}}/front_assets/images/scover.jpg"></li>
                                ...
                                <div class="card-body p-0 d-flex">
                                    ...
                                    <div class="social-media-s uncuts">

                                        <ul>

                                           

                                            <li>Welcome to Body by Lorrie's UnCUT fans page<a href="#">Click for additional

                                                pay per view content</a></li>
                                ...
                                <div class="card-body p-0 d-flex">
                                    ...
                                    <figure class="avatar me-3"><img src="{{url('/')}}/front_assets/images/user-7.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                                ...
                                <div class="card-body d-block p-0">
                                    ...
                                    <div class="row ps-2 pe-2">
                                        ...
                                        <div class="col-xs-4 col-sm-4 p-1">
                                            ...
                                            <a href="{{url('/')}}/front_assets/images/t-10.jpg" data-lightbox="roadtrip"><img src="{{url('/')}}/front_assets/images/t-10.jpg" class="rounded-3 w-100" alt="image"></a>

                                        </div>

                                        <div class="col-xs-4 col-sm-4 p-1">

                                            <a href="{{url('/')}}/front_assets/images/t-11.jpg" data-lightbox="roadtrip"><img src="{{url('/')}}/front_assets/images/t-11.jpg" class="rounded-3 w-100" alt="image"></a>

                                        </div>

                                        <div class="col-xs-4 col-sm-4 p-1">

                                            <a href="{{url('/')}}/front_assets/images/t-12.jpg" data-lightbox="roadtrip" class="position-relative d-block"><img src="{{url('/')}}/front_assets/images/t-12.jpg" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                                ...
                                <div class="card-body p-0 d-flex">
                                    ...
                                    <figure class="avatar me-3 m-0"><img src="{{url('/')}}/front_assets/images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                                ...
                                <div class="card-body d-flex p-0">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu31">
                                        ...
                                        <input type="text" value="https://www.youtube.com/" class="bg-grey text-grey-500 font-xssss border-0 lh-32 p-2 font-xssss fw-600 rounded-3 w-100 theme-dark-bg">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                ...
                                <div class="card-body p-0 d-flex">
                                    ...
                                    <figure class="avatar me-3"><img src="{{url('/')}}/front_assets/images/user-8.png" alt="image" class="shadow-sm rounded-circle w45"></figure>
                                ...
                                <div class="card-body p-0 mb-3 rounded-3 overflow-hidden">
                                    ...
                                    <video loop autoplay muted controls class="float-right w-100">
                                            ...
                                            <source src="{{url('/')}}/front_assets/images/v-2.mp4" type="video/mp4">
                                ...
                                <div class="card-body d-block p-0 mb-3">
                                    ...
                                    <div class="row ps-2 pe-2">
                                        ...
                                        <div class="col-xs-6 col-sm-6 p-1">
                                            ...
                                            <a href="{{url('/')}}/front_assets/images/t-36.jpg" data-lightbox="roadtri"><img src="{{url('/')}}/front_assets/images/t-21.jpg" class="rounded-3 w-100" alt="image"></a>

                                        </div>

                                        <div class="col-xs-6 col-sm-6 p-1">

                                            <a href="{{url('/')}}/front_assets/images/t-32.jpg" data-lightbox="roadtri"><img src="{{url('/')}}/front_assets/images/t-22.jpg" class="rounded-3 w-100" alt="image"></a>
                                    ...
                                    <div class="row ps-2 pe-2">
                                        ...
                                        <div class="col-xs-4 col-sm-4 p-1">
                                            ...
                                            <a href="{{url('/')}}/front_assets/images/t-33.jpg" data-lightbox="roadtri"><img src="{{url('/')}}/front_assets/images/t-23.jpg" class="rounded-3 w-100" alt="image"></a>

                                        </div>

                                        <div class="col-xs-4 col-sm-4 p-1">

                                            <a href="{{url('/')}}/front_assets/images/t-34.jpg" data-lightbox="roadtri"><img src="{{url('/')}}/front_assets/images/t-24.jpg" class="rounded-3 w-100" alt="image"></a>

                                        </div>

                                        <div class="col-xs-4 col-sm-4 p-1">

                                            <a href="{{url('/')}}/front_assets/images/t-35.jpg" data-lightbox="roadtri" class="position-relative d-block"><img src="{{url('/')}}/front_assets/images/t-25.jpg" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a>
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                ...
                                <div class="card-body p-0 mb-3 rounded-3 overflow-hidden">
                                    ...
                                    <video loop autoplay muted controls class="float-right w-100">
                                            ...
                                            <source src="{{url('/')}}/front_assets/images/v-1.mp4" type="video/mp4">
                                ...
                                <div class="card-body d-block p-0 mb-3">
                                    ...
                                    <div class="row ps-2 pe-2">
                                        ...
                                        <div class="col-sm-12 p-1">
                                            ...
                                            <a href="{{url('/')}}/front_assets/images/t-30.jpg" data-lightbox="roadtr"><img src="{{url('/')}}/front_assets/images/t-31.jpg" class="rounded-3 w-100" alt="image"></a>
                            ...
                            <div class="right-side">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="banner-slider clebs-sugg owl-carousel owl-theme dot-style2 owl-nav-link link-style3">
                                                        ...
                                                        <div class="owl-items style1  align-items-center">
                                                            ...
                                                            <div class="celebs">
                                                                ...
                                                                <img src="{{url('/')}}/front_assets/images/celebs1.jpg">

                                                                <div class="celebs-porfile-pic"><img src="{{url('/')}}/front_assets/images/celebs1.jpg"></div>
                                    ...
                                    <div class="col-xl-4 col-xxl-4 col-lg-4 ps-lg-0">
                                        ...
                                        <div class="card-body text-center vip-r">

                                           <a  data-toggle="modal" data-target="#uncutsubscribe"> <img src="{{url('/')}}/front_assets/images/vip.jpg"></a>

                                           <p>VIP Club member benefits</p>

                                            <h4 class="fw-700 mb-0 mt-1 font-xssss text-grey-900">Unlimited Access to VIP only

                                                private content & personalised

                                                Adults' only messaging including

                                                access into the

                                                Adults' only Q&A Forum</h4>
                                        ...
                                        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3 right-box">
                                            ...
                                            <div class="card-bodyoverflow-hidden border-top-xs bor-0">
                                                ...
                                                <a   data-toggle="modal" data-target="#videosubscribe"> <img src="{{url('/')}}/front_assets/images/vip1.png" alt="img" class="img-fluid mb-2"></a>

                                                <a href="#" class="evc">Enter VIP Club</a>

                                                <p class="small-f"><b>I'm holding a live private

                                                    photo shoot, anyone

                                                    want to join me? </b></p>

                                                    <a href="#" class="evc">Join Now</a>
