...
<div class="row">
   ...
   @endif
   <h1 class="breadcrumb-item active" aria-current="page"> update Charity Form </h1>
      ...
      <div class="card">
         <div class="card-body">
            <form class="forms-sample"  
               action="{{ route('Celeberity.Charity.update',$charity->id)}}" method="POST">
               @csrf
               @method('PUT')
