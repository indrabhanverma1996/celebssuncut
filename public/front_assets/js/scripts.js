...
$('.multi-field-wrapper').each(function() {
    ...
    $('.multi-field .remove-field-all', $wrapper).click(function() {
        if ($('.multi-field', $wrapper).length > 0)
            $(this).parent('.multi-field').remove();
    });
});

//*---inputdata change on click *//
function changeNumber(elm) {
    document.getElementById('garlicBread1').value = ' ' + elm.innerHTML + ' ';
    document.getElementById('garlicBread2').value = ' ' + elm.innerHTML + ' ';
}
//*--- clear post *//
$(".removedcrose").click(function() {
    $(".poll-area").remove();
});
//*---img upload--*//
